...
//use full macro
static const parser_t UUID_PARSER = {.type=VALUE, {.parser_function=parse_uuid_function}, .destructor=free};
static const parser_t INT_PARSER = {.type=VALUE, {.parser_function=parse_int_function}, .destructor=free};
static const parser_t STRING_PARSER = {.type=VALUE, {.parser_function=parse_string_function}, .destructor=free};
